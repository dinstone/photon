...
public class SerializerRegister {
    ...
    private Map<SerializerType, Serializer> serializerMap = new EnumMap<>(SerializerType.class);
    ...
    protected SerializerRegister() {
        regist(SerializerType.JACKSON, new JacksonSerializer());
    }

    public void regist(SerializerType type, Serializer serializer) {
        serializerMap.put(type, serializer);
    }

    public Serializer find(SerializerType serializeType) {
